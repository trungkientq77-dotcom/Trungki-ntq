...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Trung Kiên - Trường PTDTBT TH Mậu Long - ĐT: 0975.702.877</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Trung Kiên - Trường PTDTBT TH Mậu Long - ĐT: 0975.702.877</div>", unsafe_allow_html=True)
